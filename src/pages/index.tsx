              ...
              <div className='-mx-4 flex flex-wrap justify-center'>
                <div className='w-full px-4 md:w-1/2 lg:w-1/3'>
                  <div
                    ...
                    data-wow-delay='.2s'>
                    <div className='mx-auto mb-8 flex h-[90px] w-[90px] items-center justify-center rounded-3xl bg-[#FFAE00] bg-opacity-20 text-[#FFAE00] duration-300 group-hover:bg-[#FFAE00] group-hover:text-white   '>
                      <svg
                        width='40'
                        height='40'
                        viewBox='0 0 40 40'
