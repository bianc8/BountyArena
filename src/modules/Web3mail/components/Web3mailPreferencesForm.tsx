              ...
              <div className='border-b border-gray-700 pb-6'>
                <label className='block'>
                  ...
                  <Field
                    ...
                    id='email'
                    name='email'
                    className='cursor-not-allowed mt-1 mb-1 block w-full rounded-xl border border-gray-700 bg-[#191919] shadow-sm focus:ring-opacity-50'
                    placeholder='**********'
                    readOnly
                    disabled
                  />
              ...
              <label className='block'>
                <div className='mb-2 ml-0.5'>
                  ...
                  <Toogle
                    ...
                    label='A new bounty corresponding to your skills is open'
                  />
